...
export default function Experience(): JSX.Element {
  ...
  return (
    <div className="flex flex-col pt-16 pb-5 gap-20">
      <div className="flex flex-col gap-2 text-sm">
        ...
        <div className="text-xs">
          ...
          Modernized a legacy system for processes such as check encashment and
          cash deposit for digital banking. Led the creation of a dynamic form
          app. Developed a fnancial literacy and investment mobile app for new
          investors of Metrobank with over 100K+ downloads and 4.0+ star rating.
          People manager and instructor for MDI Novare&apos;s boot camp
          programs.
        </div>
      ...
      <div ref={botBrosExp} className=" flex flex-col gap-2 text-sm">
        <div className="font-bold">
        ...
        <div className="text-xs">
          ...
          responsive informational site for a company based in Berlin, Germany.
          Developed functional front-end components and back-end APIs for a
